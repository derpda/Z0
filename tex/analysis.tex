...
\begin{itemize}
	\item{\makebox[2.5cm][l]{\textbf{Elektron cut:}} Ncharged $<7$}
	\item{\makebox[2.5cm][l]{\textbf{Muon cut:}} Ncharged $=2$}
	\item{\makebox[2.5cm][l]{\textbf{Tauon cut:}} Ncharged $<7$}
...
\begin{itemize}
	\item{\makebox[2.5cm][l]{\textbf{Muon cut:}} Pcharged $>71$ GeV}
	\item{\makebox[2.5cm][l]{\textbf{Tauon cut}} Pcharged $\le60$ GeV}
\end{itemize}
...
\end{equation}
where $\Gamma_{Z}^{ave}=\unit{(2.516\pm0.017)}{GeV}$ is the weighted average of the four calculated $\Gamma_Z$. Again assuming lepton universality, the muon result was used for $\Gamma_e$.
