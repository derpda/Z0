...
\begin{frame}
	...
	\begin{table}[h]\centering
		\begin{tabular}{@{}lllllll@{}}
			\toprule
			&Event $i$&$\Gamma_{Z}$ [GeV]&$s_{\Gamma_{Z}}$ [GeV]&$\Gamma_i$ [MeV]&$s_{\Gamma_i}$ [MeV]&$\Gamma_i^{calc}$ [MeV]\\
			\midrule
			&$e^+e^-$&2.28&0.11&94&4&83.4\\
			&$\mu^+\mu^-$&2.52&0.06&82.9&1.7&83.4\\
			&$\tau^+\tau^-$&2.48&0.07&76.9&1.9&83.4\\
			&$q\overline{q}$&2.526&0.019&1777&41&1742\\
			\bottomrule
		\end{tabular}
	\end{table}
\end{frame}
