...
\begin{frame}
	...
	\begin{minipage}{0.48\linewidth}
		\begin{figure}
			\centering
			\includegraphics[width=1.0\linewidth]{../results/MC_results/ee_cut/Ncharged_vergleich}
		\end{figure}
		\begin{figure}
			\centering
			\includegraphics[width=1.0\linewidth]{../results/MC_results/mm_cut/Ncharged_vergleich}
		\end{figure}
	\end{minipage}
	\begin{minipage}{0.48\linewidth}
		\begin{figure}
			\centering
			\includegraphics[width=1.0\linewidth]{../results/MC_results/tt_cut/Ncharged_vergleich}
		\end{figure}
		\begin{figure}
			\centering
			\includegraphics[width=1.0\linewidth]{../results/MC_results/qq_cut/Ncharged_vergleich}
		\end{figure}
		\end{minipage}
\end{frame}

\begin{frame}
	\frametitle{Elektronen Ohne Cut}
