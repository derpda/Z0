...
\begin{frame}
	...
	\begin{minipage}{0.48\linewidth}
			\includegraphics[width=1.1\linewidth]{../results/MC_results/ee_cut/Ncharged_vergleich}\\
			\includegraphics[width=1.1\linewidth]{../results/MC_results/mm_cut/Ncharged_vergleich}
	\end{minipage}
	\begin{minipage}{0.48\linewidth}
			\includegraphics[width=1.1\linewidth]{../results/MC_results/tt_cut/Ncharged_vergleich}\\
			\includegraphics[width=1.1\linewidth]{../results/MC_results/qq_cut/Ncharged_vergleich}
		\end{minipage}
\end{frame}
