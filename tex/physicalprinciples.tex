...
The mixing angle $\theta_w$ is now commonly called \emph{Weinberg angle}, although it was originally the \emph{weak mixing angle}. Furthermore, it is related to the fine-structure constant  $\alpha$, the Fermi coupling constant $G_F$ and the mass of the $Z^0$ Boson \cite{muenchen}:
...
\begin{figure}[ht]
	...
	\caption[Feynman diagramm: $e^-e^+ \rightarrow f\bar{f} $(s-channel)]{Feynman diagram of the $e^-e^+ \rightarrow f\bar{f}$ in first order, where f is an arbitrary fermion. \cite{muenchen}} 
